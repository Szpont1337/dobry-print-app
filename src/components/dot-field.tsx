...
const DotField = memo(
  ({
    ...
    sparkle = false,
    waveAmplitude = 0,
    // Brand-aligned defaults: design tokens as concrete colors (canvas/SVG
    // can't take Tailwind classes) — primary / secondary-foreground / foreground.
    gradientFrom = "rgba(14, 106, 87, 0.35)",
    gradientTo = "rgba(10, 78, 64, 0.25)",
    glowColor = "#14241f",
    className,
    style,
  }: DotFieldProps) => {
